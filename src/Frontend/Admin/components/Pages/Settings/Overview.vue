<template>
    <div class="kt-container row" style="width: 100%; padding-top: 10px;">
        <div class="col-lg-3">
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
<!--                <div class="kt-portlet__head kt-portlet__head&#45;&#45;lg">-->
<!--                    <div class="kt-portlet__head-label">-->
<!--                        <h3 class="kt-portlet__head-title">Search</h3>-->
<!--                    </div>-->
<!--                </div>-->
                    ...
                    <div class="kt-widget kt-widget--user-profile-1">
                        <div class="kt-widget__head">
                            <div class="kt-widget__media">
                                <img src="/logo/100_6.jpg" alt="image">
                            </div>
                        ...
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__items">
                                <a class="kt-widget__item kt-widget__item--active" data-toggle="tab" href="#kt_portlet_base_demo_1_tab_content" role="tab">
                                ...
                                <a class="kt-widget__item "  data-toggle="tab" href="#kt_portlet_base_demo_2_tab_content" role="tab">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <a class="kt-widget__item " data-toggle="tab" href="#kt_portlet_base_demo_3_tab_content" role="tab">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <a class="kt-widget__item " data-toggle="tab" href="#kt_portlet_base_demo_4_tab_content" role="tab">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
